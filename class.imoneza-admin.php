...
class iMoneza_Admin {
    ...
    function imoneza_save_meta_box_data($post_id) {
        ...
        $data = array(
            'ExternalKey' => $post_id,
            'Active' => 1,
            'Name' => sanitize_text_field(stripslashes($_POST['imoneza_name'])),
            'Title' => sanitize_text_field(stripslashes($_POST['imoneza_title'])),
            'Byline' => sanitize_text_field(stripslashes($_POST['imoneza_byline'])),
            'Description' => sanitize_text_field(stripslashes($_POST['imoneza_description'])),
